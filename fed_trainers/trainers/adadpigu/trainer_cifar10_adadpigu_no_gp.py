...
from fed_trainers.trainers.adadpigu.trainer_adadpigu_no_gp import train_with_pruning
    ...
    for batch_size in range(800, 1500 + 1, 100):
        ...
        for lr in [0.05]:
            ...
            for pruning_rate in [0.1]:
                ...
                train_with_pruning(args, results_file, base_pruning_rate=pruning_rate)
