...
def main():
    parser = argparse.ArgumentParser(
        description="Sweep GEP Private Federated Learning CIFAR10")
    num_users = 500
    ...
    parser.add_argument("--log_name", type=str, default="Sweep_GEP_PRIVATE_CIFAR10",
                        help="dir path for logger file")
    parser.add_argument("--csv-path", type=str, default="./csv", help="dir path for csv file")
    parser.add_argument("--csv-name", type=str, default="cifar10_gep_private.csv", help="dir path for csv file")
    ...
    sweep_configuration = {
        "name": f"GEP_PRIVATE_CIFAR10_seeds{(args.seed, args.seed + 1, args.seed + 2)}",
        "method": "grid",
