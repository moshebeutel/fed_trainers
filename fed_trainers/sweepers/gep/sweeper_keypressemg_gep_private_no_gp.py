...
import torch
from fed_trainers.trainers.gep import trainer_keypressemg_gep_private_no_gp
...
if __name__ == '__main__':
    ...
    sweep_configuration = {
        "name": f"gep_private_keypressemg_{args.num_features}_{103_110}",
        "method": "grid",
        ...
        "parameters": {
            ...
            "gradients-history-size": {"values": [20, 40]},
            "wd": {"values": [0.001]},
    ...
    sweep(sweep_config=sweep_configuration, args=args,
          train_fn=trainer_keypressemg_gep_private_no_gp.train)
