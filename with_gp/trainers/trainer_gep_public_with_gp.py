...
from common.gep_utils import embed_grad, project_back_embedding, add_new_gradients_to_history, \
    compute_subspace
from common.model import get_model
from common.utils import (get_clients, get_device, flatten_tensor,
                          update_frame, log2wandb,
...
def train(args, dataloaders):
    ...
    # Test best model
    test_results, labels_vs_preds, step_results = eval_model(args, best_model, private_clients, train_loaders, test_loaders, GPs)
